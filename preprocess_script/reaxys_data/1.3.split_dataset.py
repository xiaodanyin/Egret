...
if __name__ == '__main__':
    ...
    for reaction_id in tqdm(num_3_up, total=len(num_3_up)):
        ...
        rct_id_train_df = df.loc[train_idx]
        rct_id_val_df = df.loc[val_idx]
        rct_id_test_df = df.loc[test_idx]
    ...
    for reaction_id in tqdm(num_3, total=len(num_3)):
        ...
        _rct_id_train_df = df.loc[_train_idx]
        _rct_id_val_df = df.loc[_val_idx]
        _rct_id_test_df = df.loc[_test_idx]

...
if __name__ == '__main__':
    ...
    test_df = pd.read_csv('../../dataset/source_dataset/Reaxys-MultiCondi-Yield/reaxys_group/reaxys_group_60_test_dataset_pred_category.csv', encoding = 'utf-8')
    ...
    if not test_model:
        ...
        model_path = os.path.join('../../outputs/reaxys_yield/regression/bestout')      # Egret
        # model_path = os.path.join('../../outputs/egret_wcl')                          # Egret-WCL
        model = SmilesClassificationModelSelf("bert", 
                                              model_path, 
                                              num_labels=1, 
                                              args=model_args, 
